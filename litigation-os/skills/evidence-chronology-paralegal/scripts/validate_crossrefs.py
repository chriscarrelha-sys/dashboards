...
REFERENCES = [
    ...
    # Phase 3 operating layer
    ("00-control/task-board.csv", "depends_on", {"TSK", "HD"}),
    ("00-control/task-board.csv", "blocks", {"TSK", "HD"}),
    ("00-control/task-board.csv", "unresolved_questions",
     {"OFQ", "OLQ", "ISS", "HD", "GAP", "CON"}),
    ...
    ("07-evidence/opposing-counsel-record.csv", "related_ids",
     {"CON", "GAP", "OC", "CV", "ENT", "CLM", "ATK", "ISS", "JR", "PD", "DL"}),
